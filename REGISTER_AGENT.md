...
```
plugin.yaml              → 自动注册 MCP 工具 + Skill
oh-my-openagent.json     → 配置模型（model、fallback）
.opencode/agents/forge.md → Agent 出现在下拉选择框

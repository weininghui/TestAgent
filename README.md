...
**Current release: v5.0.0** — Production quality gates, golden oracle, forge-review agent, multi-agent orchestration.
...
| Assertion quality | `analyze_assertion_quality` | `forge assert-quality` | v5.0 |
| Golden oracle | `load_golden_cases` / `verify_golden_coverage` | `forge golden` | v5.0 |
...
| Coverage expand | `coverage_expand` | `forge coverage-expand` | v4.0 |
...
- Latest notes: [RELEASE_NOTES_v5.0.0.md](docs/releases/RELEASE_NOTES_v5.0.0.md)

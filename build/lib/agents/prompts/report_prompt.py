...
def build_system_prompt(
    ...
    context:
        ...
        details.  Auto-infers defaults for the report stage if omitted.
    ...
    if isinstance(context, TaskContext):
        ...
        ctx = TaskContext.from_dict({**context, "stage": "report"})
    else:
        ctx = TaskContext(stage="report")

    return build_stage_system_prompt("report", ctx)
